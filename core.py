...
class ExportPlaylist:
    ...
    def create_csv(self, playlist_to_export, csv_filename):        
        ...
        with open(csv_filename, 'w+') as csv_file:
            dict_writer = csv.DictWriter(csv_file, restval='-', fieldnames=headers, delimiter=',')
    ...
    def export_spotify_playlist(self, playlist_id):
            ...
            playlist = spotify.user_playlist(self.username, playlist_id=playlist_id, fields='name,tracks,artist,next')
            csv_filename = playlist['name']
